...
*    Tyler Jones
* Summary:
*    This program creates a gui then uses it to create an email
...
*
*   Yourself: ____Tyler_Jones____________ Score: 10xx10
*
*   Student: _____Joe_Dzado______________ Score: 10xx10
*
*   Student: _____Ron_Moore______________ Score: 10xx10
*
*   Student: ____________________________ Score: _xx_
*
*****************************************************************************/
   ...
   class SendListener implements ActionListener
   {
      public void actionPerformed(ActionEvent event)
      {
         ...
         *  Send the message. */
         ...
         {
            System.out.println("Sending failed: " + error.getMessage());
            return;
         }
...
class SMTPConnection
{
   ...
   public SMTPConnection(Envelope envelope) throws IOException
   {
	  ...
	  if(!(fromServer.readLine().startsWith("220")))
		throw new IOException("trying to connect expecting 220");

      /* SMTP handshake. We need the name of the local machine.
      Send the appropriate SMTP handshake command. */
      String localhost = connection.getLocalAddress().getHostAddress();
   ...
   private void sendCommand(String command, int rc) throws IOException
   {
	System.out.println(command);
	  ...
	  if(!(fromServer.readLine().startsWith(Integer.toString(rc))))
		throw new IOException("sendCommandfunction cmd: "+ command);
   }
   ...
   {
      int code = Integer.parseInt(reply);
      /* Fill in */ //added above thing not sure if more needs added yet
      return code;
   }
